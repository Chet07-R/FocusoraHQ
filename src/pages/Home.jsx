...
const Home = () => {
  return (
    <>
      <main className="bg-gradient-to-r from-indigo-300 to-cyan-100 dark:from-gray-900 dark:to-gray-800 min-h-screen relative overflow-hidden pt-28 lg:pt-0">
        ...
        <div className="min-h-screen flex flex-col lg:flex-row items-center justify-between px-8 lg:px-16 py-12">
          <div className="lg:w-1/2 text-left lg:pr-12">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-blue-900 dark:text-white mb-6 tracking-tight leading-tight">
              FocusoraHQ
            </h1>

            <p className="text-xl md:text-2xl lg:text-3xl text-blue-800 dark:text-gray-300 font-medium mb-8">
              Focus. Study. Thrive.
            </p>
        ...
        <div className="left-1/2 transform flex flex-col items-center">
          <a href="#features" className="bg-blue-700 hover:bg-blue-800 text-white font-semibold py-4 px-10 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 mb-4">
            Get Started
          </a>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Link to="/my-space" className="group">
              <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border-2 border-transparent shadow-xl hover:shadow-2xl hover:border-blue-500 dark:hover:border-blue-400 hover:scale-105 hover:-translate-y-2 transition-all duration-300">
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-left">
            ...
            <ul className="space-y-4">
              <li className="flex">
                <svg className="w-6 h-6 text-indigo-500 dark:text-indigo-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div key={idx} className="bg-gray-50 dark:bg-gray-700 p-8 rounded-2xl border border-gray-200 dark:border-gray-600 shadow-lg flex flex-col items-center hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="flex items-center mb-2">
                    { Array.from({ length: 5 }).map((_, k) => (
                      <svg key={k} className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-black dark:bg-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 py-20 text-center relative z-10">
          ...
          <Link to="/signup" className="group relative mt-8 inline-block px-10 py-4 rounded-2xl overflow-hidden">
