      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 px-4">
        <div className="max-w-4xl mx-auto bg-slate-800/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 md:p-12 border-2 border-purple-500/30">
          ...
          <div className="space-y-6 text-gray-200">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">2. Use License</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">3. User Accounts</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">4. Privacy & Data</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">5. Content & Study Materials</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">6. Community Guidelines</h2>
              <p className="leading-relaxed mb-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">7. Study Rooms & Collaboration</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">8. Disclaimer</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">9. Limitations</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">10. Termination</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">11. Changes to Terms</h2>
              <p className="leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-purple-300 mb-3">12. Contact Us</h2>
              <p className="leading-relaxed">
