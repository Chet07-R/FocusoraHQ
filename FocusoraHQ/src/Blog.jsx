      ...
      <section className="py-16 bg-white dark:bg-gray-800">
        <div className="container mx-auto px-6 mt-6">
          ...
          <div className="max-w-4xl mx-auto space-y-6 mt-6">
            {/* Popular Article 1 */}
            <Link to="/blog/1" className="block mb-6">
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    <span className="inline-block bg-blue-700 text-white px-3 py-1 rounded-full text-xs font-semibold uppercase">
                      Trending
                    </span>
                    <h3 className="mt-3 text-xl font-bold text-gray-900 dark:text-white hover:text-blue-700 dark:hover:text-blue-400 transition-colors duration-300">
                    ...
                    <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">8 min read • 50,000 views</div>
                  </div>
                </div>
              </div>
            </Link>
            ...
            {/* Popular Article 2 */}
            <Link to="/blog/2" className="block mb-6">
              <div className="bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-gray-700 dark:to-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-start space-x-6">
                  <img
                  ...
                  />
                  <div className="flex-1">
                    <span className="inline-block bg-cyan-600 text-white px-3 py-1 rounded-full text-xs font-semibold uppercase">
                      Popular
                    </span>
                    <h3 className="mt-3 text-xl font-bold text-gray-900 dark:text-white hover:text-blue-700 dark:hover:text-blue-400 transition-colors duration-300">
                    ...
                    <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">12 min read • 42,000 views</div>
                  </div>
                </div>
              </div>
            </Link>
            ...
            {/* Popular Article 3 */}
            <Link to="/blog/3" className="block mb-6">
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-700 dark:to-gray-700 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex items-start space-x-6">
                  <img
                  ...
                  />
                  <div className="flex-1">
                    <span className="inline-block bg-indigo-600 text-white px-3 py-1 rounded-full text-xs font-semibold uppercase">
                      Essential
                    </span>
                    <h3 className="mt-3 text-xl font-bold text-gray-900 dark:text-white hover:text-blue-700 dark:hover:text-blue-400 transition-colors duration-300">
                    ...
                    <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">15 min read • 38,000 views</div>
                  </div>
                </div>
              </div>
            </Link>
